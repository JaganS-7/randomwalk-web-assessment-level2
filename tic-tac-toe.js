...
function updateScore() {
    ...
    scoreCard.innerHTML = `Player X: ${playerXScore} | Player O: ${playerOScore}`; // Update the score card in the HTML
}
...
function showWinningAnimation(winner) {
    ...
    winningMessage.textContent = `Hurray! Player ${winner} won!`; // Set the text content of the winning message
